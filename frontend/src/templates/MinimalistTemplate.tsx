    ...
    >
      ...
      {summary && (
        <div className="mini-section">
          <div className="mini-section-title">个人简介</div>
      ...
      {work_experience.length > 0 && (
        <div className="mini-section">
          <div className="mini-section-title">工作经历</div>
      ...
      {education.length > 0 && (
        <div className="mini-section">
          <div className="mini-section-title">教育背景</div>
          {education.map((edu, i) => (
            <div key={i} className="mini-entry">
              <div className="mini-entry-header">
      ...
      {skills.length > 0 && (
        <div className="mini-section">
          <div className="mini-section-title">专业技能</div>
      ...
      {projects.length > 0 && (
        <div className="mini-section">
          <div className="mini-section-title">项目经验</div>
          {projects.map((proj, i) => (
            <div key={i} className="mini-entry">
              <div className="mini-entry-header">
      ...
      {certifications.length > 0 && (
        <div className="mini-section">
          <div className="mini-section-title">证书与奖项</div>
      ...
      {custom_sections && custom_sections.length > 0 && custom_sections.map((section, i) => (
        <div key={i} className="mini-section">
          <div className="mini-section-title">{section.title}</div>
          <div className="mini-custom-content">{section.content}</div>
        </div>
      ))}
    </div>
  )
